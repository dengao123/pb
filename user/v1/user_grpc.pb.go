...
type UserClient interface {
	...
	DeleteUser(ctx context.Context, in *IdRequest, opts ...grpc.CallOption) (*CheckResponse, error)
}
...
func (c *userClient) DeleteUser(ctx context.Context, in *IdRequest, opts ...grpc.CallOption) (*CheckResponse, error) {
	out := new(CheckResponse)
...
type UserServer interface {
	...
	DeleteUser(context.Context, *IdRequest) (*CheckResponse, error)
...
func (UnimplementedUserServer) DeleteUser(context.Context, *IdRequest) (*CheckResponse, error) {
